...
const ZonePicker = ({
    ...
    configs: ZoneConfig[];
    onUpdateZone: (id: string, label: string) => void;
    onAddZone: () => void;
    ...
    return (
        <div className="flex flex-col gap-4 mb-10">
            ...
            <div className="flex flex-wrap gap-4 p-6 bg-white/5 rounded-[32px] border border-white/10 shadow-2xl items-center">
                {configs.map((zone) => (
                    <div
                        key={zone.id}
                        ...
                        // Використовуємо прямо HEX для світіння
                    ...
                    >
                        ...
                        <div className="flex items-center gap-2">
                            {/* ВИПРАВЛЕНО: використовуємо style для фону (HEX колір) */}
                            <div
                            ...
                            <input
                                ...
                                onChange={(e) => onUpdateZone(zone.id, e.target.value)}
